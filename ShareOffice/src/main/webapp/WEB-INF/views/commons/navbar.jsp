...
<div class="row bg-gray-c_3c" style=" margin: auto;" id="banner">
   ...
   <div class="col-8 pt-1 pb-1 pl-4 text-center" onclick="location.href='/'">
      <img alt="logo" src="../resources/img/RealLogoNav.png" class="img-fluid">
   </div>
   <div class="col-2"></div>
</div>
...
<div class="offcanvas offcanvas-start w-75" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="background-color: #e0e0e0">
  ...
  <div class="offcanvas-body">
    ...
    <div class="row mt-4 mb-3">
    	<div class="col cursor-pointer text-fs-16" style="font-weight: bold; color: #333;"><i class="bi bi-building text-black"></i> 오피스</div>
    </div>
	...
	<c:if test="${!empty sessionUser }">
		<div class="row mt-4 mb-3">
	    	<div class="col cursor-pointer text-fs-16" style="font-weight: bold; color: #333;"><i class="bi bi-person text-black"></i> 호스트</div>
	    </div>
		<c:choose>
	...
	<div class="row mt-4 mb-3">
    	<div class="col cursor-pointer text-fs-16" style="font-weight: bold; color: #333;"><i class="bi bi-telephone text-black"></i> 고객센터</div>
    </div>
	<div class="row mt-1 ms-1">
